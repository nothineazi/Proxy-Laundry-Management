              ...
              <!-- Footer -->
				...
				<form class="form-horizontal" role="form" id="" action="" method="post">
				  <div class="form-group">
				    ...
				    <div class="col-sm-9">
				      <input type="text" class="form-control" name="name" id="customer" placeholder="Enter service  Name" required>
				    </div>
				  </div>
				  <div class="form-group">
				    <label class="control-label col-sm-3" for="">Service Cost:</label>
				    <div class="col-sm-9">
				      <input type="text" class="form-control" name="cost" id="customer" placeholder="Enter the Service Cost" required>
				    </div>
				  </div>
				  <div class="form-group"> 
